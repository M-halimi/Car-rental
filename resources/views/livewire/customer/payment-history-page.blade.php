    ...
    <div class="container mx-auto px-4 py-8">
            ...
            <div class="bg-[rgba(255,255,255,0.06)] border border-[rgba(255,255,255,0.08)] rounded-xl p-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div class="text-white/55 text-sm">{{ __('frontend.total_paid') }}</div>
                    </div>
                </div>
            </div>
            <div class="bg-[rgba(255,255,255,0.06)] border border-[rgba(255,255,255,0.08)] rounded-xl p-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div class="text-white/55 text-sm">{{ __('frontend.pending_payments') }}</div>
                    </div>
                </div>
            </div>
            <div class="bg-[rgba(255,255,255,0.06)] border border-[rgba(255,255,255,0.08)] rounded-xl p-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div class="text-white/55 text-sm">{{ __('frontend.last_payment') }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        @if($payments->isEmpty())
            <div class="bg-[rgba(255,255,255,0.06)] border border-[rgba(255,255,255,0.08)] rounded-xl p-16 text-center">
                ...
                <p class="text-white/55 text-lg mb-6">{{ __('frontend.no_payments_yet') }}</p>
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="border-b border-[rgba(255,255,255,0.06)]">
                                <th class="px-6 py-4 text-left text-xs font-medium text-white/40 uppercase tracking-wider">{{ __('frontend.date') }}</th>
                                <th class="px-6 py-4 text-left text-xs font-medium text-white/40 uppercase tracking-wider">{{ __('frontend.car') }}</th>
                                <th class="px-6 py-4 text-left text-xs font-medium text-white/40 uppercase tracking-wider">{{ __('frontend.amount') }}</th>
                                <th class="px-6 py-4 text-left text-xs font-medium text-white/40 uppercase tracking-wider">{{ __('frontend.method') }}</th>
                                <th class="px-6 py-4 text-left text-xs font-medium text-white/40 uppercase tracking-wider">{{ __('frontend.status') }}</th>
                                <th class="px-6 py-4 text-left text-xs font-medium text-white/40 uppercase tracking-wider">{{ __('frontend.type') }}</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-[rgba(255,255,255,0.04)]">
                            @foreach($payments as $payment)
                                <tr class="hover:bg-[rgba(255,255,255,0.03)] transition">
                                    ...
                                    <td class="px-6 py-4 text-sm text-white/55">{{ ucfirst(str_replace('_', ' ', $payment->payment_method)) }}</td>
                                    <td class="px-6 py-4">
                                        ...
                                        @else
                                            <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-xs font-medium bg-white/5 text-white/55 border border-[rgba(255,255,255,0.1)]">
                                                {{ ucfirst($payment->status) }}
                                            </span>
                                        @endif
                                    </td>
